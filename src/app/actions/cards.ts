...
const FRONTIER_LEGENDS = [
  { name: 'Tumbleweed', rarity: 'Common', special_attribute: 'Agility +1', description: 'Blows where the wind takes it. Good for a quick getaway.', image_url: '/cards/tumbleweed.png' },
  { name: 'Rusty Revolver', rarity: 'Common', special_attribute: 'Attack +2', description: 'It jams on occasion, but it is better than throwing rocks.', image_url: '/cards/rusty_revolver.png' },
  { name: 'Old Boot', rarity: 'Common', special_attribute: 'Stamina +1', description: 'Found in a dry creek bed. Smells like 1849.', image_url: '/cards/old_boot.png' },
  { name: 'Iron Spur', rarity: 'Common', special_attribute: 'Speed +2', description: 'Makes a satisfying jingle with every step.', image_url: '/cards/iron_spur.png' },
  { name: 'Cactus Juice', rarity: 'Uncommon', special_attribute: 'Heals 15 HP', description: 'Tastes terrible, but stops the bleeding.', image_url: '/cards/cactus_juice.png' },
  { name: 'Bandit Mask', rarity: 'Uncommon', special_attribute: 'Stealth +3', description: 'Hides your identity from the law and the flies.', image_url: '/cards/bandit_mask.png' },
  { name: 'Snake Skin', rarity: 'Uncommon', special_attribute: 'Poison Resist', description: 'Shed by a rattler near the O.K. Corral.', image_url: '/cards/snake_skin.png' },
  ...
  { name: 'Stagecoach Wheel', rarity: 'Common', special_attribute: 'Repair +5', description: 'A sturdy spare for the long road to San Francisco.', image_url: '/cards/stagecoach_wheel.png' },
  { name: 'Cowboy Hat', rarity: 'Common', special_attribute: 'Style +2', description: 'A wide-brimmed classic. Keeps the sun out of your eyes.', image_url: '/cards/cowboy_hat.png' },
